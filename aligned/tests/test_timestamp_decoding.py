...
async def test_unix_timestamp() -> None:
    ...
    sources_to_test: list[DataFileReference] = [
        FileSource.parquet_at(
            "test_data/data/parquet_unix.parquet", date_formatter=formatter
        ),
    ...
    converted_data = data.with_columns(
        [formatter.encode_polars("et"), formatter.encode_polars("timestamp")]
    )
...
async def test_iso_timestamp() -> None:
    ...
    sources_to_test = [
        ...
        FileSource.parquet_at(
            "test_data/data/parquet_iso.parquet", date_formatter=formatter
        ),
