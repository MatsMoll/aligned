...
class EqualsFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        from aladdin.schemas.transformation import Equals
...
class RatioFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        from aladdin.schemas.transformation import Ratio
...
class OrdinalFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        from aladdin.schemas.transformation import Ordinal
...
class ContainsFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        from aladdin.schemas.transformation import Contains as ContainsTransformation
...
class NotEqualsFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        from aladdin.schemas.transformation import NotEquals as NotEqualsTransformation
...
class GreaterThenFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        from aladdin.schemas.transformation import GreaterThen, GreaterThenValue
...
class GreaterThenOrEqualFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        from aladdin.schemas.transformation import GreaterThenOrEqual as GTETransformation
...
class LowerThenFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        from aladdin.schemas.transformation import LowerThen as LTTransformation
...
class LowerThenOrEqualFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        from aladdin.schemas.transformation import LowerThenOrEqual as LTETransformation
...
class DifferanceBetweenFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        from aladdin.schemas.transformation import Subtraction
...
class AdditionBetweenFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        from aladdin.schemas.transformation import Addition
...
class TimeDifferanceFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        from aladdin.schemas.transformation import TimeDifference as TDTransformation
...
class LogTransformFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        from aladdin.schemas.transformation import LogarithmOnePluss
...
class ReplaceFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        from aladdin.schemas.transformation import ReplaceStrings
...
class ToNumericalFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        from aladdin.schemas.transformation import ToNumerical as ToNumericalTransformation
...
class IsInFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        from aladdin.schemas.transformation import IsIn as IsInTransformation
...
class AndFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        from aladdin.schemas.transformation import And as AndTransformation
...
class OrFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        from aladdin.schemas.transformation import Or as OrTransformation
...
class InverseFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        from aladdin.schemas.transformation import Inverse as InverseTransformation
...
class FillMissingFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        from aladdin.schemas.transformation import FillNaValues
...
class FloorFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        from aladdin.schemas.transformation import Floor
...
class CeilFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        from aladdin.schemas.transformation import Ceil
...
class RoundFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        from aladdin.schemas.transformation import Round
...
class AbsoluteFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        from aladdin.schemas.transformation import Absolute
...
class DillTransformationFactory(TransformationFactory):
    ...
    async def compile(self, source_views: list[CompiledFeatureView]) -> Transformation:
        ...
        from aladdin.schemas.transformation import DillTransformation
