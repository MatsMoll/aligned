...
class FeatureFactory:
    ...
    def compile_graph_only(self) -> DerivedFeature:
        from aladdin.schemas.transformation import CopyTransformation
    ...
    def fill_na(self: T, value: Any) -> T:
        from aladdin.compiler.transformation_factory import (
    ...
    def transformed(
        ...
        from aladdin.compiler.transformation_factory import DillTransformationFactory
...
class EquatableFeature(FeatureFactory):
    ...
    def __eq__(self, right: FeatureFactory | Any) -> Bool:  # type: ignore[override]
        from aladdin.compiler.transformation_factory import EqualsFactory
    ...
    def __ne__(self, right: FeatureFactory | Any) -> Bool:  # type: ignore[override]
        from aladdin.compiler.transformation_factory import NotEqualsFactory
...
class ComparableFeature(EquatableFeature):
    def __lt__(self, right: object) -> Bool:
        from aladdin.compiler.transformation_factory import LowerThenFactory
    ...
    def __le__(self, right: float) -> Bool:
        from aladdin.compiler.transformation_factory import LowerThenOrEqualFactory
    ...
    def __gt__(self, right: object) -> Bool:
        from aladdin.compiler.transformation_factory import GreaterThenFactory
    ...
    def __ge__(self, right: object) -> Bool:
        from aladdin.compiler.transformation_factory import GreaterThenOrEqualFactory
...
class ArithmeticFeature(ComparableFeature):
    def __sub__(self, other: FeatureFactory) -> Float:
        from aladdin.compiler.transformation_factory import DifferanceBetweenFactory, TimeDifferanceFactory
    ...
    def __add__(self, other: FeatureFactory) -> Float:
        from aladdin.compiler.transformation_factory import AdditionBetweenFactory
    ...
    def __truediv__(self, other: FeatureFactory) -> Float:
        from aladdin.compiler.transformation_factory import RatioFactory
    ...
    def __abs__(self) -> Float:
        from aladdin.compiler.transformation_factory import AbsoluteFactory
    ...
    def standard_scaled(self, timespan: timedelta | None = None, limit: int | None = None) -> Float:
        from aladdin.compiler.transformation_factory import StandardScalingFactory
...
class DecimalOperations(FeatureFactory):
    def __round__(self) -> Int64:
        from aladdin.compiler.transformation_factory import RoundFactory
    ...
    def __ceil__(self) -> Int64:
        from aladdin.compiler.transformation_factory import CeilFactory
    ...
    def __floor__(self) -> Int64:
        from aladdin.compiler.transformation_factory import FloorFactory
...
class InvertableFeature(FeatureFactory):
    def __invert__(self) -> Bool:
        from aladdin.compiler.transformation_factory import InverseFactory
...
class LogicalOperatableFeature(InvertableFeature):
    def __and__(self, other: Bool) -> Bool:
        from aladdin.compiler.transformation_factory import AndFactory
    ...
    def __or__(self, other: Bool) -> Bool:
        from aladdin.compiler.transformation_factory import OrFactory
...
class String(CategoricalEncodableFeature, NumberConvertableFeature):
    ...
    def replace(self, values: dict[str, str]) -> String:
        from aladdin.compiler.transformation_factory import ReplaceFactory
    ...
    def contains(self, value: str) -> Bool:
        from aladdin.compiler.transformation_factory import ContainsFactory
