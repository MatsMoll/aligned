...
from aladdin.retrival_job import DateRangeJob, FactualRetrivalJob, FullExtractJob, CombineFactualJob
...
class JobFactory(ABC):
    ...
    def facts(self, facts: dict[str, list], sources: dict[Source, RetrivalRequest]) -> CombineFactualJob:
